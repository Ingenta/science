Template.addArticleForSpecialTopics.events({
...
Template.searchArticleForAddToSpecialTopics.helpers({
    publishers: function () {
...
Template.searchArticleForAddToSpecialTopics.events({
...
Template.searchArticleForAddToSpecialTopics.onRendered(function(){
    Session.set("journalId", null);
    Session.set("volume", null);
