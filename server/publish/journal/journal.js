...
Meteor.publish('journalBrowseTabVolumeList', function (journalShortTitle) {
    ...
    return [
        ...
        Issues.find({journalId: {$in: idArr}}, {fields: {updateDate:0,createDate: 0}, sort: {order: -1},limit:400})
    ]
});
...
Meteor.publish('journalBrowseTabIssuesList', function (journalShortTitle) {
    ...
    return [
        Issues.find({journalId: {$in: idArr}}, {fields: {updateDate:0,createDate: 0}, sort: {order: -1},skip:400})
    ]
});
